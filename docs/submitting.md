...
- Make sure that the software complies with the [JOSS review criteria](review_criteria.md). In particular, your software should be full-featured, well-documented, and contain procedures (such as automated tests) for checking correctness.
